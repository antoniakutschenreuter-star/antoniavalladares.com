...
/* ---- Galerie-Layout jetzt rein über CSS (Masonry / columns) ----
   Stub bleibt erhalten, damit der Portfolio-Tab-Code keinen Fehler wirft. ---- */
window.__layoutGalleries = function () {};
